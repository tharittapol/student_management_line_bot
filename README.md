...
| คำสั่ง | คำอธิบาย |
|--------|----------|
| `/ตารางเรียน` | ตารางเรียนสัปดาห์นี้ พร้อมเบอร์โทรติดต่อ |
| `/ตารางเวลา` | slot ว่าง/จอง ทุกชั่วโมง 10:00–17:00 |
| `/ข้อมูลนักเรียน` | รายชื่อนักเรียนที่เรียนอยู่ พร้อมผู้ปกครองและเบอร์โทร |
| `/วิธีใช้งาน` | แสดงคำสั่งทั้งหมดใน LINE |
...
| รูปแบบ | ความหมาย |
|--------|----------|
| `9/5` | วันที่ 9 พ.ค. ปีปัจจุบัน |
| `9/5/2570` | ปี พ.ศ. ที่ระบุ (2570 = 2027) |
| `9 พ.ค. 13:00-15:00` | ชื่อเดือนไทยย่อ |

⏰ ระบบส่งตารางเรียนอัตโนมัติทุกวัน 09:00 (`Asia/Bangkok`)
